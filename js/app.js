    ...
    (() => {
        ...
        function searchInit() {
            if (document.querySelector(".icon-search")) document.addEventListener("click", (function(e) {
                if (e.target.closest(".icon-search")) document.documentElement.classList.toggle("search-open"); else if (document.documentElement.classList.contains("search-open") && !e.target.closest(".search__inner")) document.documentElement.classList.toggle("search-open");
            }));
        }
            ...
            function initRatings() {
                ...
                async function setRatingValue(value, rating) {
                    if (!rating.classList.contains("rating_sending")) {
                        ...
                        } else rating.classList.remove("rating_sending");
                    }
                }
            }
        }
        ...
        function initSliders() {
            ...
            if (document.querySelector(".search__slider")) new swiper_core_Swiper(".search__slider", {
                modules: [],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                if (screenWidth <= 1280) {
                    if (!api) {
                        ...
                        const menu = new Mmenu("#menu", {
                            ...
                            panel: ".menu__body",
                            language: "ru",
                            extensions: [ "fx-menu-slide", "shadow-page" ]
                        });
                        api = menu.API;
                        document.querySelector("#qwe").addEventListener("click", openMmenu);
                    }
                } else if (api) {
                    closeMmenu();
                    api = null;
                    document.querySelector("#qwe").removeEventListener("click", openMmenu);
                }
            }
            function openMmenu() {
                api.open();
